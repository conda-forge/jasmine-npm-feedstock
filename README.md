...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/jasmine-npm-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/jasmine-npm-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add jasmine-npm
# for installing globally
pixi global install jasmine-npm
```
...
It is possible to list all of the versions of `jasmine-npm` available on your platform:
...
```
pixi search jasmine-npm --channel conda-forge
```
